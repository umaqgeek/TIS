            	...
            	<table border="1" align="center">
                    ...
                    <?php
						...
						while($project = mysql_fetch_array($res1)){
							...
							echo "<td align='center'><a href='../adminfunc/project_view.php?view=$project[project_id]'>View</a></td>";
							echo "<td align='center'><a href='../adminfunc/project_delete.php?delete=$project[project_id]'>Delete</a></td>";
