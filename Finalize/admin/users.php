...
<div class="main">
        ...
        <div class="content">
            	...
            	<table border="1" align="center">
					...
					$row = mysql_fetch_array($res, MYSQL_ASSOC);
						...
						while($user = mysql_fetch_array($res1)){
							...
							echo "<td align='center'><a href='../adminfunc/user_view.php?view=$user[user_id]'>View</a></td>";
							echo "<td align='center'><a href='../adminfunc/user_delete.php?delete=$user[user_id]'>Delete</a></td>";
            ...
            <div>
            	<form action="../adminfunc/user_add.php" method="post">
                	<table align="center">
