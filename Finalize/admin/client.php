            	...
            	<table border="1" align="center">
                    ...
                    <?php
						...
						while($client = mysql_fetch_array($res1)){
							...
							echo "<td align='center'><a href='../adminfunc/client_view.php?view=$client[client_id]'>View</a></td>";
							echo "<td align='center'><a href='../adminfunc/client_delete.php?delete=$client[client_id]'>Delete</a></td>";
